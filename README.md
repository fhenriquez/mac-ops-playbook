...
## Forked from [GeerlingGuy](https://github.com/geerlingguy/mac-dev-playbook)

This playbook installs and configures most of the software I use on my Mac as an Infrastructure Administrator. Focusing on AWS, Openstack and vCenter. Some things in macOS are slightly difficult to automate, so I still have some manual installation steps, but at least it's all documented here.
